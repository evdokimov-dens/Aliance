  ...
  <body class="front-page">
    <div class="mobile-menu">
      ...
      <div class="mobile-info-social">
        <svg class="social-icon-vk" width="24" height="24">
          <use href="img/sprite.svg#vk"></use>
        </svg>
      </div>
      <div class="mobile-info-social">
        <svg class="social-icon-inst" width="24" height="24">
      ...
      <div class="container">
        ...
        <div class="cards">
          <a href="#" class="card">
            ...
            <!-- /.card-content -->
            <img src="img/avto.png" alt="Автомобильная химия" class="card-image" />
          </a>
          <a href="#" class="card">
            <div class="card-content">
            ...
            <!-- /.card-content -->
            <img src="img/byt.png" alt="Бытовая химия" class="card-image" />
          </a>
          <a href="#" class="card">
            <div class="card-content">
            ...
            <!-- /.card-conten -->
            <img src="img/dez.png" alt="Дезинфицирующие средства" class="card-image" />
          </a>
          <a href="#" class="card">
            <div class="card-content">
            ...
            <!-- /.card-content -->
            <img src="img/dez.png" alt="Пищевые аэрозоли" class="card-image" />
          </a>
          <a href="#" class="card">
            <div class="card-content">
            ...
            <!-- /.card-content -->
            <img src="img/avto.png" alt="Косметическая продукция" class="card-image" />
          </a>
          <a href="#" class="card">
            <div class="card-content">
            ...
            <!-- /.card-content -->
            <img src="img/byt.png" alt="Краски аэрозольные" class="card-image" />
          </a>
        </div>
        <!-- /.cards -->
      </div>
        ...
        <div class="founder-content-wrapper">
          <div class="founder-content">
            ...
            <p class="founder-text">
              ...
              укрепление и развитие внутренней структуры говорит о возможностях соответствующих условий активизации.
              Внезапно, независимые государства, которые представляют собой яркий пример континентально-европейского
              типа политической культуры, будут подвергнуты целой серии независимых исследований. С учётом сложившейся
        ...
        <div class="swiper blog-slider">
          ...
          <div class="swiper-wrapper">
            ...
            <a href="#" class="swiper-slide blog-card">
              <img src="/img/pixels-tima.jpg" alt="" class="blog-card-image" />
              <h3 class="blog-card-title"></h3>
            </a>
            <a href="#" class="swiper-slide blog-card">
              <img src="/img/pixels-pixa.jpg" alt="" class="blog-card-image" />
              <h3 class="blog-card-title"></h3>
            </a>
            <a href="#" class="swiper-slide blog-card">
              <img src="/img/pixels-tima.jpg" alt="" class="blog-card-image" />
